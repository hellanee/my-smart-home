...
public class LivingRoomActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.living_room_layout);
    ...
    private void setUpDevicesModels(){
        String[] devicesNames = getResources().getStringArray(R.array.living_room_devices);
        int[] switchStates = getResources().getIntArray(R.array.living_room_switches);
